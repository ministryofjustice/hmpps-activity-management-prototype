...
router.get("./search-for-a-prisoner", function (req, res) {
  res.render(req.protoUrl + "/search-for-a-prisoner-results");
});

// post route for search-for-a-prisoner-results page
router.post("/search-for-a-prisoner-results", function (req, res) {
